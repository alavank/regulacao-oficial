...
export function Demandas() {
  ...
  const { demandas, loading } = useDemandas(filtros)
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {isAdmin ? 'Todas as demandas do sistema' : 'Suas demandas de saúde'}
            </p>
          </div>
        </div>
        <Link
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="text-left px-4 py-3 font-medium text-gray-600 hidden lg:table-cell">Tempo</th>
